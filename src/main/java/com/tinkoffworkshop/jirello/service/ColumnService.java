...
import com.tinkoffworkshop.jirello.support.ColumnMapper;
...
public class ColumnService {
    ...
    public ColumnResponse createColumnOnBoard(ColumnRequest columnRequest) {
        ...
        if (boardEntity.isEmpty()) throw new RuntimeException("board not find");
    ...
    public List<ColumnResponse> deleteColumnFromBoard(Long columnId, Long boardId) {
        ...
        if (columnEntityForDelete.isEmpty()) throw new RuntimeException("column not find");
    ...
    public ColumnResponse updateColumnOnBoard(Long columnId, Long boardId, ColumnRequest columnRequest) {
        ...
        if (columnEntity.isEmpty()) throw new RuntimeException("column not find");
    ...
    public ColumnResponse swapColumnPositions(Long columnId, Long boardId, Integer positionBefore, Integer positionAfter) {
        ...
        if (columnEntity.isEmpty()) throw new RuntimeException("column not found");
